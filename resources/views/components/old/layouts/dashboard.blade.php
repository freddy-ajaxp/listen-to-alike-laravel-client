                            ...
                            <div class="form-row">
                                <div class="col-sm-2">
                                    <select id="data_platform${counter}" name="data_platform[]" class="form-control form-control-sm">
                                        ...
                                        <option value="youtube"><img id="bg_img" src="https://images.unsplash.com/photo-1605711590391-26f38bdfc5ba?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max"></option>
